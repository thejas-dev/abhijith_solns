...
export default function QueryCardStaff({query,j,loading,addReply}) {
	...
	return (
		<div className="flex flex-col gap-2">
			...
			className={`flex bg-gray-50 p-3 ${openReplies ? 'pb-3' : 'pb-2'} rounded-xl border-[1px] border-gray-300 
			flex-col gap-1`}>
				...
				<h1 className="text-sm text-gray-600 mb-1 leading-none">{query?.query}</h1>
				{
					openReplyBox ? 
